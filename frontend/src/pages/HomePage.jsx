...
import { FileEarmarkText, People, ClockHistory, PlusCircle,ShieldLock,Lightning,PersonPlus,BoxArrowInRight } from 'react-bootstrap-icons'
                            ...
                            <Card className='border-0 shadow-sm'>
                                <Card.Body className='d-flex align-items-center gap-3 p-3'>
                                    ...
                                    <div>
                                        ...
                                        <div className='fw-bold fs-5'>{user.accessToDocuments?.length ?? 0}</div>
                                    </div>
                                </Card.Body>
                            </Card>
                        </div>
                    ...
                    <Card.Body className='p-4'>
                        <div className='d-flex align-items-center justify-content-between mb-3'>
                            ...
                            <Button
                                ...
                                onClick={() => navigate('/documents/?mode=create')}
                            >
                                <PlusCircle size={16} />
                                Новый документ
                            </Button>
